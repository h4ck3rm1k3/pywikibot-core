...
class MovePagesBot:
    ...
    def treat(self, page):
        ...
        if self.addprefix or self.appendAll or self.regexAll:
            ...
            choice = pywikibot.inputChoice('What do you want to do?',
                                           ['change page name',
                                            'append to page name',
            ...
            if choice == 'c':
                ...
                if namesp:
                    choice2 = pywikibot.inputChoice(
                        'Do you want to remove the namespace prefix "%s:"?'
                        % namesp, ['yes', 'no'], ['y', 'n'])
                    if choice2 == 'y':
                        #noNamespace = True
                        pass
    ...
    for arg in pywikibot.handleArgs():
        if arg.startswith('-pairs'):
            ...
            if len(arg) == len('-summary'):
                summary = pywikibot.input('Enter the summary:')
            else:
                summary = arg[9:]
        else:
